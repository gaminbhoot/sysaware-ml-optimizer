...
def test_run_pipeline_executes_full_flow(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(main, "get_system_profile", lambda: {"cpu_cores": 8, "ram_gb": 16.0, "gpu_available": True, "gpu_name": "RTX 4070", "gpu_vram_gb": 12.0, "os": "Windows 11"})
...
def test_run_pipeline_requires_prompt_text_when_prompt_optimizer_enabled(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(main, "get_system_profile", lambda: {"cpu_cores": 8, "ram_gb": 16.0, "gpu_available": False, "gpu_name": "None", "gpu_vram_gb": 0.0, "os": "Windows 11"})
